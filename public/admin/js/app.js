...
adminApp.config(function($stateProvider, $urlRouterProvider){
	...
	.state('dashboard', {
		...
		// .state('moreList', {
		// 	url: '/moreList',
		// 	templateUrl: '/admin/templates/moreList.html',
		// 	resolve: {
		// 		moreList: function(Users){
		// 			return Users.all().then(function(data){
		// 				return data;
		// 			});
		// 		}
		// 	},
		// 	controller: 'AllmoreCtrl'
		// })
		...
		.state('editTestimonial', {
			url: '/editTestimonial/:paraml',
			templateUrl: '/admin/templates/editTestimonial.html',
		...
		.state('InnovateList', {
			url: '/InnovateList',
			templateUrl: '/admin/templates/innovateList.html',
			resolve: {
				InnovateList: function(Innovate){
					return Innovate.all().then(function(data){
						return data;
					});
				}
			},
			controller: 'InnovateListCtrl'
		})
