var express = require('express'),
        ...
        Innovate = require('./models/innovate'),
...
function isAdmin(req, res, next) {
    if (req.isAuthenticated() && req.user.email === "divyabhatnagar@gmail.com") {
